...
![plugdata main window](../images/plugdata_main_interface_markup.png)
...
![add object menu](../images/add_object_menu.png)
...
![palettes](../images/palette_panel.png)
...
![canvas coordinate space](../images/canvas-overview.png)
...
![plugdata border to pd vanilla](../images/canvas-overview-plugin-mode.png)

> PD-Vanilla will show scrollbars when canvas elements are near the edge. It is important that plugdata saves the window size 1:1, even if PD-Vanilla chooses to display scrollbars. If this is an issue for your use case, consider adding padding to the right / bottom of the canvas dimensions.
...
![plugin mode pd vanilla](../images/plugdata-plugin-mode-pd-vanilla.png)
...
![add parameter panel](../images/add_parameter_panel.png)
...
![automation walkthrough](../images/automation_parameter_walkthrough.gif)

### 14) Overlay selector menu:

![overlay selector menu](../images/overlay_selector_menu.png)
...
![snapping menu](../images/snapping_menu.png)
